...
SECRET_KEY = '9xkb%_(w$=jc@s22l)ctj-z)co36evbhw!@@1!r=&dfoy+&-8r'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME') or 'blog',
        'USER': os.environ.get('DB_USER') or 'blog',
...
# Email settings using GMAIL as SMTP
